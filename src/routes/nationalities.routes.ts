...
nationalitiesRoutes.use(checkAuthMiddleware)

nationalitiesRoutes.get('/nationalities', (request, response) => {
...
nationalitiesRoutes.delete('/nationalities/:id', (request, response) => {
